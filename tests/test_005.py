# Test openql editor, log and button layouts
...
# 
	...
	def qasmEditor(self):
		...
		self.btnQ2C = QtWidgets.QPushButton(u"\u2193",self)
		# self.btnQ2C.clicked.connect(self.convQ2C)
		self.btnQ2C.setFixedSize(self.win_cx*0.015,self.win_ry*0.03)
		self.btnLayoutQ.addWidget(self.btnQ2C,QtCore.Qt.AlignCenter)
