...
class Window(QtGui.QMainWindow):
	...
	def fileMenu(self):
		...
		self.menuFileNewProj.setShortcut("Ctrl+O")
	...
	def viewMenu(self):
		...
		self.menuViewThemes.setStatusTip('select themes')
	...
	def helpMenu(self):
		...
		self.menuHelpTutorial = QtGui.QAction("&Tutorial",self)
		self.menuHelpTutorial.triggered.connect(self.TBD)
		self.menuHelp.addAction(self.menuHelpTutorial)
		self.menuHelpTutorial.setEnabled(False)				# (TBD)

		self.menuHelpDocs = QtGui.QAction("&Documentation",self)
		self.menuHelpDocs.triggered.connect(self.TBD)
		self.menuHelp.addAction(self.menuHelpDocs)
		self.menuHelpDocs.setEnabled(False)					# (TBD)
